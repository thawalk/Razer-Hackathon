        ...
        body: Center(
            child: SizedBox(
                ...
                child: Thermometer(
                  ...
                  //Highest target
                  setpoint: (
                      Setpoint(7500, size: 12,
                          color: Colors.blue,
                          side: SetpointSide.right)
                  ),
                  label: ThermometerLabel("Total Savings (\$)",),
                  scale: IntervalScaleProvider(2500,thickness: 3.0,fractionDigits: 0,length: 20.0),
...
//    }
//  }
      const url = 'https://light.microsite.perxtech.io/game/3?token=6bead735994ceb98d99b022293423c05f3358dd659a00a08d0243b4ce8c8b77d';
